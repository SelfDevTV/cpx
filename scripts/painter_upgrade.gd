...
func _on_credits_upgr_pressed() -> void:
	painter_r.upgrade_credits_per_pixel(Globals.pixel_canvas.upgrades.credits)
	update_button_text()


func _on_cooldown_upgr_pressed() -> void:
	painter_r.upgrade_paint_cooldown(Globals.pixel_canvas.upgrades.credits)
	update_button_text()

func _on_speed_upgr_pressed() -> void:
	painter_r.upgrade_speed(Globals.pixel_canvas.upgrades.credits)
	update_button_text()
